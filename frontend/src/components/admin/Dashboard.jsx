import { 
  ...
  Globe, Zap, Shield, Calendar, Download,
  Cpu, Network, Brain
} from 'lucide-react';
import { 
...
export default function Dashboard() {
  ...
  const trafficData = [
    { name: '00:00', users: 120, syncs: 80  },
    { name: '04:00', users: 80,  syncs: 60  },
    { name: '08:00', users: 450, syncs: 320 },
    { name: '12:00', users: 820, syncs: 640 },
    { name: '16:00', users: 950, syncs: 780 },
    { name: '20:00', users: 650, syncs: 500 },
    { name: '23:59', users: 300, syncs: 220 },
  ];

  const activityByCluster = [
    { name: t('dashboard.charts.clusters.digital'), value: 450, color: '#7BB342', status: t('dashboard.charts.status.optimal'), icon: Cpu },
    { name: t('dashboard.charts.clusters.infra'), value: 320, color: '#1B365D', status: t('dashboard.charts.status.stable'),  icon: Network },
    { name: t('dashboard.charts.clusters.ai'), value: 210, color: '#8B5CF6', status: t('dashboard.charts.status.syncing'), icon: Brain },
  ];
  ...
  return (
    <AdminLayout 
      ...
      actions={[
        ...
        { icon: <Download size={14} />, label: t('dashboard.actions.export'), primary: true },
      ]}
    >
